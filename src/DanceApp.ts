...
export class DanceApp extends gfx.GfxApp {
    ...
    createScene(): void {
        ...
        this.camera.position.set(0, 1.5, 3.5); // 0, 1.5, 3.5
    ...
    loadMotionClips(): void {
        ...
        motion2.loadFromAMC('./assets/data/05_13.amc', this.balletBoneData);
        this.balletDanceMotions.push(motion2);

        const motion3 = new MotionClip();
        motion3.loadFromAMC('./assets/data/05_08.amc', this.balletBoneData);
        this.balletDanceMotions.push(motion3);

        const motion4 = new MotionClip();
        motion4.loadFromAMC('./assets/data/05_03.amc', this.balletBoneData);
        this.balletDanceMotions.push(motion4);

        const motion5 = new MotionClip();
        motion5.loadFromAMC('./assets/data/05_11.amc', this.balletBoneData);
    ...
    onSkeletonsAndMotionClipsLoaded(): void {
        ...
        this.balletDanceMotions[1].trimBack(50);

        this.balletDanceMotions[2].trimFront(170);
        this.balletDanceMotions[2].trimBack(150);

        this.balletDanceMotions[3].trimFront(50);
        this.balletDanceMotions[3].trimBack(50);

        this.balletDanceMotions[4].trimFront(20);
        this.balletDanceMotions[4].trimBack(80);
