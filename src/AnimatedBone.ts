...
export class AnimatedBone extends gfx.Node3 {
    ...
    applyPose(pose: Pose): void {
        ...
        const jointSpaceMatrix = pose.getJointRotationMatrix(this.name);
        const boneSpace = this.boneSpaceToParentBoneSpace.clone();
        boneSpace.multiplyAll(this.jointSpaceToBoneSpace, jointSpaceMatrix, this.boneSpaceToJointSpace)
        this.setLocalToParentMatrix(boneSpace, false);
